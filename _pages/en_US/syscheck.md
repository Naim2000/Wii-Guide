...
5. You may wish to share the `syscheck.csv` file located on the root of your SD card/USB drive.
Optionally, you can press the `A` button to upload the file to (syscheck.rc24.xyz)[http://syscheck.rc24.xyz/].
The `IOSsysCheck.log` file (saved to the root as well) contains additional information about your IOS.
